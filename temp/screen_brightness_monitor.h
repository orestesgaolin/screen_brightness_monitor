...
#ifndef SCREEN_BRIGHTNESS_MONITOR_SWIFT_H
#define SCREEN_BRIGHTNESS_MONITOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="screen_brightness_monitor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP25screen_brightness_monitor18BrightnessCallback_")
@protocol BrightnessCallback
/// Called when the screen brightness changes.
/// \param brightness the new brightness value (0–255).
///
- (void)onBrightnessChanged:(NSInteger)brightness;
@end

/// Monitors screen brightness and notifies registered callbacks of changes.
SWIFT_CLASS("_TtC25screen_brightness_monitor23ScreenBrightnessMonitor")
@interface ScreenBrightnessMonitor : NSObject
...
- (void)startObservingWithCallback:(id <BrightnessCallback> _Nonnull)callback;
